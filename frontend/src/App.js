...
import PaymentSuccess from "./Pages/PayMethods/PaymentSuccess";
import PaymentError from "./Pages/PayMethods/PaymentError";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "recipient-information/:cardId",
        element: (
          <ProtectedRoute>
      ...
      {
        path: "payment/:type/:cardId/:price",
        element: (
          <ProtectedRoute>
            <Payment />
          </ProtectedRoute>
      ...
      {
        path: "details-after-buying/:cardPrice",
        element: (
          <ProtectedRoute>
            <DetailsAfterBuying />
          </ProtectedRoute>
